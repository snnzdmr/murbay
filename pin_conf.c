...
void Pin_Init(void)
{
    ...
    SYS->GPA_MFPH = SYS_GPA_MFPH_PA12MFP_GPIO;
    ...
    SYS->GPB_MFPL = SYS_GPB_MFPL_PB7MFP_GPIO | SYS_GPB_MFPL_PB5MFP_GPIO | SYS_GPB_MFPL_PB4MFP_GPIO | SYS_GPB_MFPL_PB2MFP_GPIO | SYS_GPB_MFPL_PB0MFP_UART2_RXD;
