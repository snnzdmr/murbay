...
__attribute__((weak)) void SCREEN_1_AIP_ResetPin(uint8_t _val){

}

__attribute__((weak)) void SCREEN_1_AIP_A0Pin(uint8_t _val){

}


__attribute__((weak)) void SCREEN_1_AIP_CSPin(uint8_t _val){

}

__attribute__((weak)) void SCREEN_2_AIP_ResetPin(uint8_t _val){

}

__attribute__((weak)) void SCREEN_2_AIP_A0Pin(uint8_t _val){

}


__attribute__((weak)) void SCREEN_2_AIP_CSPin(uint8_t _val){

}

__attribute__((weak)) void SCREEN_3_AIP_ResetPin(uint8_t _val){

}

__attribute__((weak)) void SCREEN_3_AIP_A0Pin(uint8_t _val){

}

__attribute__((weak)) void SCREEN_3_AIP_CSPin(uint8_t _val){
...
static uint8_t spi_transfer(uint8_t *_data){
 uint8_t _buf;
  ((((SPI_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x21000UL)))->TX = (_data[0]));
    while (( ((((SPI_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x21000UL)))->STATUS & (0x1ul << (0)))>>(0) ));
  while ((((((SPI_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x21000UL)))->STATUS & (0x1ul << (8)))>>(8)) == 0){
  _buf = ((((SPI_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x21000UL)))->RX);
  }
 return _buf;
}
...
static uint8_t AIP_writeChar(uint8_t *_chr,FontDef *Font,AIP *p){
  ...
  if (*_chr < 32 || *_chr > 126){
    ...
    if ((p->AIP_currentPos.x_pos + Font->FontWidth) > 19)
    {
        return 0;
    }
