...
void APP_Init(){
 ...
 ptrWorkVariable->saveButtonFlag =0;
...
void APP_setSaveButtonIcon(_Bool _state,AIP *p){
 if(_state == 1){
   p->Spoint(4,1,p);
 }
 else{
...
void APP_setuNITButtonIcon(_Bool _state,AIP *p){
 if(_state == 1){
   p->Spoint(6,1,p);
 }
 else{
...
void APP_setStableIcon(_Bool _state,AIP *p){
 if(_state == 1){
   p->Spoint(8,1,p);
 }
 else{
...
void APP_PointsHandle(){
 if(ptrWorkVariable->saveButtonFlag == 0){
   APP_setSaveButtonIcon(0,p_LcdObj_S1);
 }
 else{
   APP_setSaveButtonIcon(1,p_LcdObj_S1);
 }
 if(ptrWorkVariable->unitButtonFlag == 0){
  APP_setuNITButtonIcon(0,p_LcdObj_S1);
 }
 else{
  APP_setuNITButtonIcon(1,p_LcdObj_S1);
 }
 if(ptrWorkVariable->stableFlag == 0){
  APP_setStableIcon(0,p_LcdObj_S1);
 }
 else{
...
float customValueInputFix(char pressedKey,AIP *p,MENU_Params *p_MenuParam){
 ...
 switch(pressedKey){
   ...
   case 'q':
    break;
   case 's':
    if(ptrWorkVariable->saveButtonFlag == 1){
     ptrWorkVariable->saveButtonFlag = 0;
    }
    else{
     ptrWorkVariable->saveButtonFlag = 1;
    }
    break;
   case 'p':
    break;
   case 'u':
    if(ptrWorkVariable->unitButtonFlag == 1){
     ptrWorkVariable->unitButtonFlag = 0;
    }
    else{
     ptrWorkVariable->unitButtonFlag = 1;
    }
    break;
   case 'm':
    break;
...
void SCREEN_1_AIP_A0Pin(uint8_t _val){
 (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(0))) + ((3)<<2))))=_val;
}

void SCREEN_1_AIP_CSPin(uint8_t _val){
 (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(0))) + ((4)<<2))))=_val;
}
...
void SCREEN_2_AIP_ResetPin(uint8_t _val){
 (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(1))) + ((2)<<2))))=_val;
}

void SCREEN_2_AIP_A0Pin(uint8_t _val){
 (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(1))) + ((5)<<2))))=_val;
}

void SCREEN_2_AIP_CSPin(uint8_t _val){
 (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(1))) + ((4)<<2))))=_val;
}
...
void SCREEN_3_AIP_ResetPin(uint8_t _val){
 (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(1))) + ((7)<<2))))=_val;
}

void SCREEN_3_AIP_A0Pin(uint8_t _val){
 (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*(1))) + ((8)<<2))))=_val;
}
...
_Bool APP_GetMeasure(float *_weight,MENU_Params *p_MenuParam){
 ...
 if(p_ScaleObj->available() == 1){
    *_weight = p_ScaleObj->getWeight(1,8);
 }
