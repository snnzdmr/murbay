...
# 56 "../../../../Library/StdDriver/src/retarget.c"
FILE __stdout;
FILE __stdin;
...
# 85 "../../../../Library/StdDriver/src/retarget.c"
...
# 102 "../../../../Library/StdDriver/src/retarget.c"
static void DumpStack(uint32_t stack[])
{
# 114 "../../../../Library/StdDriver/src/retarget.c"
}
...
# 186 "../../../../Library/StdDriver/src/retarget.c"
    __attribute__((weak))
...
uint32_t ProcessHardFault(uint32_t lr, uint32_t msp, uint32_t psp)
{
    uint32_t *sp;
    uint32_t inst;
# 204 "../../../../Library/StdDriver/src/retarget.c"
        if (lr & 4UL)
        {
            sp = (uint32_t *)psp;
        }
...
# 227 "../../../../Library/StdDriver/src/retarget.c"
    inst = (*((vu16 *) (sp[6])));
...
{
# 384 "../../../../Library/StdDriver/src/retarget.c"
    SendChar_ToUART(ch);

}
# 398 "../../../../Library/StdDriver/src/retarget.c"
char GetChar(void)
{
...
# 526 "../../../../Library/StdDriver/src/retarget.c"
int fputc(int ch, FILE *stream)
{
    SendChar(ch);
    return ch;
}
# 582 "../../../../Library/StdDriver/src/retarget.c"
int fgetc(FILE *stream)
{
    return ((int)GetChar());
}
# 602 "../../../../Library/StdDriver/src/retarget.c"
int ferror(FILE *stream)
{
    return (-1);
}
