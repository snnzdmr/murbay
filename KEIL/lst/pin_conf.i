...
# 131 "../pin_conf.c"
    ...
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPD_MFPL = (0x00UL<<(12)) | (0x00UL<<(8)) | (0x00UL<<(4)) | (0x00UL<<(0));
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPF_MFPL = (0x0aUL<<(12)) | (0x0aUL<<(8)) | (0x0eUL<<(4)) | (0x0eUL<<(0));
